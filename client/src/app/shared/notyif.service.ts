...
export class NotyfService {
  private notyf = new Notyf({
    ...
    dismissible: true,
    types: [
      { type: 'success', background: '#28a745', icon: { className: 'fa fa-check', tagName: 'i' } },
      { type: 'error',   background: '#dc3545', icon: { className: 'fa fa-times', tagName: 'i' } },
      { type: 'info',    background: '#17a2b8', icon: { className: 'fa fa-info', tagName: 'i' } },
      { type: 'warning', background: '#ffc107', icon: { className: 'fa fa-trash', tagName: 'i', color: '#212529' } },
    ],
  });
